...
# Example button creation lines with modified styles
tk.Button(root, text="Add", command=Add, font=("Arial", 12), height=2, width=11, bd=0, relief=tk.FLAT, bg="green", fg="white").place(x=80, y=230)
