...
def logout():
    root.destroy()
    subprocess.Popen(["python", "landing.py"])  # Replace "python" with your Python interpreter if needed
...
tk.Button(root, text="Back", command=logout, height=3, width=13).place(x=580, y=210)
